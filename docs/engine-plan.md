...
#### Phase 8d — Custom Game UI (spec'd 2026-08-16, in progress)
...
*Next: the station screen (six tabs over the existing `station_ui.*` fill/execute seam), HUD parity, then delete the provisional ImGui HUD and station code.*
