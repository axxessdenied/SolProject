...
SOL_TEST(zlibInflateFixedHuffman)
{
    ...
    const std::uint8_t data[] = {0x78, 0xda, 0xcb, 0x48, 0xcd, 0xc9, 0xc9,
...
SOL_TEST(inflateRejectsCorruptInput)
{
    ...
    // Corrupted Adler-32
    const std::uint8_t badChecksum[] = {0x78, 0xda, 0xcb, 0x48, 0xcd, 0xc9, 0xc9,
                                        0x07, 0x00, 0x06, 0x2c, 0x02, 0x16};
    out.clear();
